          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <span className={currentTheme.text}>Hours Slept:</span>
              ...
              {/* Healthy Diet */}
              <div className="flex items-center justify-between">
                <span className={currentTheme.text}>Healthy Diet:</span>
              ...
              {/* Water Intake */}
              <div className="flex items-center justify-between">
                <span className={currentTheme.text}>Water Intake:</span>
                <div className="flex gap-1.5">
              ...
              {/* Productivity */}
              <div className="flex items-center justify-between">
                <span className={currentTheme.text}>Productivity:</span>
                <div className="flex gap-1.5">
              ...
              {/* Overall Mood */}
              <div className="flex items-center justify-between">
                <span className={currentTheme.text}>Overall Mood:</span>
                <div className="flex gap-1.5">
                  {[
                    { icon: '😢', label: 'Sad' },
                    { icon: '😐', label: 'Neutral' },
